...
const newTestCases: {
  ...
  {
    title: 'getCard - UUID - First try - OK',
    input: {
  ...
  {
    title: 'getCard - UUID - First try - Ignore language',
    input: {
  ...
  {
    title: 'getCard - UUID - First try - KO',
    input: {
  ...
  {
    title: 'getCard - UUID - Best Guess - OK',
    input: {
      name: '4c85d097-e87b-41ee-93c6-0e54ec41b174',
      quantity: 1,
      customFlags: new Map(),
  ...
  {
    title: 'getCard - UUID - Best Guess - Ignore language',
    input: {
      name: '6a058a72-ebfe-4957-a7dd-ee7471db2498',
      quantity: 1,
      language: 'es',
  ...
  {
    title: 'getCard - UUID - Best Guess - KO',
    input: {
      name: '4c85d097-e87b-41ee-93c6-0e54ec41b175',
      quantity: 1,
      customFlags: new Map(),
...
newTestCases.forEach((testCase) => {
  test(testCase.title, (t) => {
    return scryfallHelper.getCard(testCase.input, testCase.firstTry)
